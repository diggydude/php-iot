...
# software's author and the end user.
  ...
  class Parameter
  {
    ...
    static function constrain($param, $min, $max)
    {
    ...
    static function scale($param, $srcMin, $srcMax, $destMin, $destMax)
    {
      $ratio = 1 / (($srcMax - $srcMin) / $param);
      $param = (($destMax - $destMin) * $ratio) + $destMin;
      return $param;
    } // scale

    static function inRange($param, $min, $max)
    {
